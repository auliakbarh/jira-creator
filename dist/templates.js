...
exports.TEMPLATES = {
    bug: {
        ...
        buildDescription: (a) => `**Steps to reproduce:**\n${a['steps']}\n\n**Expected behavior:**\n${a['expected']}\n\n**Actual behavior:**\n${a['actual']}\n\n**Environment:** ${a['env']}`,
    },
    story: {
        name: 'User Story',
        issuetype: 'Story',
        ...
        buildDescription: (a) => `**As a** ${a['role']},\n**I want to** ${a['goal']},\n**So that** ${a['benefit']}\n\n**Acceptance Criteria:**\n${a['ac']}`,
    },
    task: {
        name: 'Technical Task',
        issuetype: 'Task',
        ...
        buildDescription: (a) => `**What needs to be done:**\n${a['what']}\n\n**Definition of Done:**\n${a['dod']}`,
    },
    epic: {
        name: 'Epic',
        issuetype: 'Epic',
        ...
        buildDescription: (a) => `**Objective:**\n${a['objective']}\n\n**In Scope:**\n${a['scope']}\n\n**Out of Scope:**\n${a['outscope']}\n\n**Success Metric:**\n${a['kpi']}`,
    },
};
function applyTemplate(key, answers, overrides = {}) {
